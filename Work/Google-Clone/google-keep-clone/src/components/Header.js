...
function Header({ toggleDarkMode, isDarkMode, setCurrentPage, currentPage, onImageUpload, onRemoveImage, hasImage }) {
    ...
    <header className="header">
      ...
      <div className="header-content">
        ...
        <div className="header-actions">
          <button onClick={handleUploadClick} className="header-action-btn">
            Set BG
          </button>
          {hasImage && (
            <button onClick={onRemoveImage} className="header-action-btn">
              Remove BG
            </button>
          )}
        </div>
